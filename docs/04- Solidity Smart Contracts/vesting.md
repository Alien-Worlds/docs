...
Contract for handling the Alien Worlds tokens on the Ethereum blockchain with functionality more limited to vesting related actions related to tokens on the WAX equivalent [token contract](https://github.com/dallasjohnson/alienworlds-architecture/blob/master/docs/token.md)
